        ...
        <div className="w-full flex flex-col px-4 sm:px-[55px] mt-10 gap-4">
            ...
            <nav className="w-full flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0">
                ...
                <div className="flex justify-center sm:justify-start w-full sm:w-auto gap-4 sm:gap-10 font-english-serif text-[1rem] sm:text-[1.45rem]">
                    <Link href="/" className="btn flex flex-col items-center text-xs sm:text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"
                            className="w-6 h-6 sm:w-8 sm:h-8 fill-current color-primary icon-accent-hover">
                            <path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z" />
                        </svg>
                        <span className="mt-1">Home</span>
                    </Link>

                    <Link href="/pages/catalog" className="btn flex flex-col items-center text-xs sm:text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"
                            className="w-6 h-6 sm:w-8 sm:h-8 fill-current color-primary icon-accent-hover">
                    ...
                    <Link href="/pages/account" className="btn flex flex-col items-center text-xs sm:text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"
                            className="w-6 h-6 sm:w-8 sm:h-8 fill-current color-primary icon-accent-hover">
                    ...
                    <Link href="/pages/cart" className="btn flex flex-col items-center text-xs sm:text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"
                            className="w-6 h-6 sm:w-8 sm:h-8 fill-current color-primary icon-accent-hover">
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-1 pb-4 sm:pb-6">
                ...
                <Link href="/pages/catalog/sciences/adab" className="btn px-4 py-2 rounded-md border border-gray-300 hover:bg-gray-100 transition font-english-serif">Islamic Etiquette</Link>
            </div>
        </div>
    );
}
