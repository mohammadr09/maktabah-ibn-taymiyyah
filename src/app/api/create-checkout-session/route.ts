...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log("Stripe items:", items, "Shipping:", shipping);
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      shipping_options: [
        {
          shipping_rate_data: {
            type: "fixed_amount",
            fixed_amount: {
              amount: shipping.amount * 100, // e.g., 650 for $6.50
              currency: "usd",
            },
      ...
      success_url: `${process.env.NEXT_PUBLIC_BASE_URL}/routes/success`,
